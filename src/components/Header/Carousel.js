        ...
        <div className='carousel' >
          ...
          <SwiperSlide>
            ...
            <div className="carousel-text">
              ...
              <p>We provide tailored digital marketing solutions that help businesses increase their online visibility, engage their target audience, and drive conversions.</p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <img className="image" src={invention} alt="Image 3" style={{ height: "100vh", width: "100vw" }} />
            <div className="carousel-text">
